...
d4 <- c(1,2,3,4);
d5 <- c(1,4);
input_data <- list(A=d0,B=d1,C=d2,D=d3,E=d4,F=d5);

#output-img
output_image_file <- "venngoog.tiff"

# configures
title <- 'VennDiagramTest';
fill_color <- c("mediumorchid4","azure1","gray24","darkolivegreen","grey13");
